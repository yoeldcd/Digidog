...
/**
 * Human-readable title and body rendered by the shell notification stack.
 */
export interface NotificationText {
    /**
     * Concise outcome classification suitable for a notification heading.
     * @type {string}
     */
    title: string;
    /**
     * Specific operation result or actionable failure explanation.
     * @type {string}
     */
    message: string;
}
