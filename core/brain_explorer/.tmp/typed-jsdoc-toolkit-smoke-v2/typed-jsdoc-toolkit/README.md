...
```powershell
py '.\$agent\scripts\brain.py' clone-snippet typed-jsdoc-toolkit -d build --json
```
...
```powershell
node build/typed-jsdoc-toolkit/format-typed-jsdoc.mjs --project-root=. --source-root=src --tsconfig=tsconfig.json
node build/typed-jsdoc-toolkit/audit-typed-jsdoc.mjs --project-root=. --source-root=src
```
...
{
  "scripts": {
    "format:typed-jsdoc": "node build/typed-jsdoc-toolkit/format-typed-jsdoc.mjs --project-root=. --source-root=src --tsconfig=tsconfig.json",
    "audit:typed-jsdoc": "node build/typed-jsdoc-toolkit/audit-typed-jsdoc.mjs --project-root=. --source-root=src"
  }
}
```
