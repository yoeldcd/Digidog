...
For more details about @Mia read: `py {LOCAL_BRAIN_SCRIPT} get-memory-index character.identity.self`
For more details about @User read: `py {LOCAL_BRAIN_SCRIPT} get-memory-index user.identity.self`
