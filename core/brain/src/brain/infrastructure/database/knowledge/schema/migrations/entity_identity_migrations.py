...
from brain.infrastructure.database.knowledge.schema.migrations.migration_helpers import table_exists
from brain.infrastructure.database.knowledge.schema.migrations.type_assertion_migrations import upsert_entity_type_assertion
