...
from brain.infrastructure.database.knowledge.schema.migrations.entity_identity_migrations import (
    create_entity_identity_indexes,
    merge_duplicate_entities_by_normalized_name,
)
from brain.infrastructure.database.knowledge.schema.migrations.migration_helpers import ensure_column
from brain.infrastructure.database.knowledge.schema.migrations.source_migrations import migrate_sources_identity_contract
from brain.infrastructure.database.knowledge.schema.migrations.type_assertion_migrations import (
