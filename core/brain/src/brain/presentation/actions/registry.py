...
ACTION_HANDLERS: dict[str, str] = {
    ...
    "set-memory-entry": "brain.presentation.actions.memory.command_set_memory_entry",
    "get-memory-entry": "brain.presentation.actions.memory.command_get_memory_entry",
    "show-records": "brain.presentation.actions.records.command_show_records",
    "add-record": "brain.presentation.actions.records.command_add_record",
    ...
    "rename-log-domain": "brain.presentation.actions.logs.command_rename_log_domain",
    ...
    "rename-task-domain": "brain.presentation.actions.backlog.command_rename_task_domain",
    "read-task": "brain.presentation.actions.backlog.command_read_task",
    ...
    "registre-image": "brain.presentation.actions.pictures.command_registre_image",
...
def get_action_handler(command_name: str) -> Callable | None:
    """Resolve and cache the executable handler for a command name.

    Args:
        command_name (str): Canonical CLI command name.
