...
from brain.presentation.avatar.communication.contracts.models import DeliveryMode, ReplyRequestDTO
from brain.presentation.avatar.communication.contracts.payloads import ConsumerMessagePayload
