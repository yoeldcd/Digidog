...
def parse_patch_request(serialized_specification: str) -> PatchRequest:
    ...
    Raises:
        PatchSpecificationError: JSON, Unicode, type, field, or duplicate-target
        validation fails.
    """
    ...
    _reject_unknown_fields(parsed_value, {"edits", "creates", "moves", "deletes"}, "patch specification")
